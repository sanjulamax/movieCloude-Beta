        ...
        <div className=" absolute   w-full h-fit bg-black text-white p-3">
            <div className="flex justify-around">
                <div>
                    ...
                    <div className="flex mb-3"><img src="/src/assets/phone.png"  width='30'></img><h2 className="ml-3 ">Tel : 077-7611408</h2></div>
                    <div className="flex"><img src="/src/assets/gmail.webp"  width='30'></img><a href="mailto:sanjulasavindu@gmail.com" className="ml-3">Email : sanjulasavindu@gmail.com</a></div>
                </div>
                <div>
              <h1 className=" text-lg ml-3">Follow Us On</h1><br></br>
                <a href="https://www.linkedin.com/in/savindu-abeywickrama-58a828311"><div className="flex mb-3"><img src="/src/assets/li23.png"  width='30'></img><h2 className="ml-3">LinkedIn</h2></div></a>
                <a href="https://www.youtube.com/@slnoobhacker4903"><div className="flex mb-3"><img src="/src/assets/ytsn.png"  width='30'></img><h2 className="ml-3">Youtube</h2></div></a>
                <a href='https://github.com/sanjulamax'><div className="flex mb-3"><img src="/src/assets/git10.png"  width='30'></img> <h2 className="ml-3">GitHub</h2></div></a>
                </div>

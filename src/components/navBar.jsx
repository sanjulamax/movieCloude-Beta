...
return()=>unSub},[])
    ...
    <div className='flex flex-col  '>
        ...
        <img src='/src/assets/logo .png' alt='logo' className='hidden  max-[431px]:flex max-[431px]:w-3/6 max-[431px]:h-4/6  max-[431px]:items-center max-[431px]:mt-[-10px] max-[431px]:mb-2 max-[431px]:ml-[23%] w-1/3 h-16 ml-10 rounded-xl' />
       <div className='flex items-center justify-between'> <div className='h-[30px]  hidden max-[431px]:flex bg-white ml-3 mb-2 w-[30px] p-[1px] rounded--md ' onClick={colapsNav}><img className='h-[100%]' src='/src/assets/121081.png' alt=''></img></div>
...
<img src='/src/assets/logo .png' alt='logo' className='max-[431px]:w-2/6  max-[431px]:hidden max-[431px]:h-5/6max-[431px]:items-end w-1/3 h-16 ml-10 rounded-xl' />
...
<img src='/src/assets/dps.jpg' alt='mail' className={`${logHider? '' : 'hidden'} w-10 h-10 ml-6 rounded-full`} />
</div></div>: null }
                ...
                {loading ?  null : <div><a href='/Cart'> <button className={`  ${logHider? '' : 'hidden'} border-2 border-red-500 text-white m-3 p-1 rounded-xl bg-red-500 hover:bg-transparent hover:border-2 hover:border-red-500 `}>Cart</button></a>
                      ...
                      <p className={` ${logHider? '' : 'hidden'} text-white flex  border-2 border-emerald-50 w-[150px] overflow-hidden h-8 justify-center `}>🧑‍💻{dname} </p></div>}
                       ...
                       <img src='/src/assets/dps.jpg' alt='mail' className={`${logHider? '' : 'hidden'} w-10 rounded-full h-10 ml-6`} /> 
                </div>
        </div>
